...
//    CGContextFillEllipseInRect(context, CGRectMake(start.x-5.0f, start.y-5.0f, 10.0f, 10.0f));
//    CGContextFillEllipseInRect(context, CGRectMake(end.x-5.0f, end.y-5.0f, 10.0f, 10.0f));
